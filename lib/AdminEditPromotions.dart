...
class AdminEditPromotionsPage extends StatefulWidget {
  ...
  final String shopPromoDescription;
  final String shopPromoImage;
  final String shopPromoId;

  const AdminEditPromotionsPage(
      {super.key,
      required this.shopName,
      required this.shopPromoDescription,
      required this.shopPromoId,
      required this.shopPromoImage});

  @override
  State<AdminEditPromotionsPage> createState() => _AdminEditPromotionsPage();
}

class _AdminEditPromotionsPage extends State<AdminEditPromotionsPage> {
                ...
                onPressed: () {
                  if (shopNameController.text.trim().isEmpty) {
                    ...
                    Map<String, String> promotions = {
                      'id': widget.shopPromoId,
                      'name': shopNameController.text.trim(),
                      'image': image_url,
                      'description': descriptionController.text.trim()
                    };
                    dbRef2.update(promotions).then((value) {
                      Fluttertoast.showToast(
